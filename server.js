...
// Kendi Gemini API Anahtarınızı Buraya Ekleyin (AIzaSy... ile başlamalı)
const GEMINI_API_KEY = process.env.GEMINI_API_KEY || "BURAYA_SADECE_AIzaSy_ILE_BASLAYAN_KEYI_YAZIN";
